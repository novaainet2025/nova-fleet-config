...
| `primary_agent` | codex / opencode / cursor-agent / gemini / nvidia | task_type별 매핑 |
...
해당 시 자동 호출:
```
mcp__nco-commands__nco-discussion(arguments="opencode,gemini,codex: <정제된 의도>. 5턴 cap.")
```
...
# 동작·테스트 — ollama 우선, 오프라인이면 gemini fallback
